...
def simulate(planner_cfg, agent_cfg, filter_cfg, extra_cfg, density_fn, render_fn, get_rays_fn):
    ...
    steps = traj.get_actions().shape[0]   # 24 in original case
...
if __name__ == "__main__":
    ...
    start_state = torch.cat( [start_pos, init_rates, start_R.reshape(-1), init_rates], dim=0 )  # 3 3 9 3 -> 18
    ...
    rot = torch.tensor([[0., 0., 1.], [1., 0., 0.], [0., 1., 0.]], device=device, dtype=torch.float32)    # mark don't understand why we need rotate
